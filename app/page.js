    ...
    dangerouslySetInnerHTML={{
      __html: `
        const slides = [
          {
            ...
            description: "Carreira, liderança feminina e desenvolvimento profissional."
          },
          {
            image: "/lideranca.jpg",
            title: "Liderança & Gestão",
            description: "Atuação como Gerente Sênior liderando operações e gestores."
          }
        ];
        ...
        setInterval(() => {
          ...
          document.getElementById("dynamicImage").src = slides[current].image;
          document.getElementById("dynamicTitle").innerText = slides[current].title;
          document.getElementById("dynamicDescription").innerText = slides[current].description;
